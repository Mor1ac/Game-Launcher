...
if (menuItems[0]) menuItems[0].classList.add("menu__item-active");
if (launcherSettings[0]) launcherSettings[0].classList.add("launcher__settings--active");
